...
async function dvsyr() {
    ...
    .append('rect')
        ...
        .attr('fill','white')
        .transition().duration(tt).delay(function(d,i) {return(i-1)*10 + tdel;})
    ...
    .append('rect')
        ...
        .attr('width',function(d,i) {return xs(start_yr);})
        .attr('fill',clrs['Continental'])
        .transition().duration(tt).delay(function(d,i) {return(i-1)*10 + tdel + tt;})
    ...
    .append('rect')
        ...
        .attr('width',function(d,i) {return xs(start_yr);})
        .attr('fill',clrs['Maritime'])
        .transition().duration(tt).delay(function(d,i) {return(i-1)*10 + tdel + 2*tt;})
