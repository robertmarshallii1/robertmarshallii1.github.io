...
async function dvsyr() {
    ...
    function update(selectedGroup) {
        ...
        .attr('y',function(d,i) {return ys(parseInt(d[selectedGroup])+5);})
        .attr('height',function(d,i) {return h-2*margin-ys(parseInt(d[selectedGroup])+5);})
        .attr('x',function(d,i) {return xs(parseInt(d.YYYY));})
        .attr('width',function(d,i) {return xs(start_yr);})
    ...
    .append('rect')
        .attr('id','ttips')
        .attr('y',function(d,i) {return ys(parseInt(d.ALL)+5);})
        .attr('height',function(d,i) {return h-2*margin-ys(parseInt(d.ALL)+5);})
        .attr('x',function(d,i) {return xs(parseInt(d.YYYY));})
        .attr('width',function(d,i) {return xs(start_yr);})
        .attr('opacity',0.0)
        .attr('stroke-width',0)
...
async function decadeplots() {
    ...
    for (i=0; i < dfs.length; i++) {
        ...
        .append('rect')
            .attr('id','ttips2')
            .attr('y',function(d,i) {return ys(parseInt(d.KL)+10);})
            .attr('height',function(d,i) {return h-2*margin-ys(parseInt(d.KL)+10);})
            .attr('x',function(d,i) {return xs(d.Activity);})
            .attr('width',xs.bandwidth())
            .attr('opacity',0.0)
            .attr('stroke-width',0)
